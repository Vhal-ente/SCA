const events = [
  ...
  },
  {
    ...
    image: "/assets/whatshappening/whatshappening_pathoflegends_img.png", // replace with your image path
...
export default function () {
  return (
    <section className="bg-[#36f6c6] py-12 px-6 md:px-16 text-center">
