...
export default function AuthLayout() {
  return (
    <div className="max-w-7xl h-[1343px] min-w-full">
      <div className="bg-[url('/assets/the_colosseum.jpg')] bg-cover bg-center h-full relative px-6 py-10">
        {/* AN OVERLAY */}
      ...
      <div className="bg-[#292925] h-80 max-w-full px-6 py-10">
        <Footer />
      </div>
    </div>
  );
