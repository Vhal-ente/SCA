...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="w-full text-white bg-black px-4 py-3 flex items-center justify-between relative z-30">
        {/* Logo */}
        ...
        {/* Mobile Menu */}
        <div
          className={`absolute left-0 top-full w-full bg-black/80 backdrop-blur-md z-20 transition-all duration-300 overflow-hidden ${
